...
INSTALL_FILE="glassfish-installer-v2ur1-b09d-linux.jar"
SRC_URI="!ml? (
			http://download.java.net/javaee5/v2ur1/promoted/Linux/${INSTALL_FILE} 
			)
		ml? ( http://download.java.net/javaee5/v2ur1/promoted/Linux/glassfish-installer-v2ur1-b09d-linux-ml.jar )
 		"
