...
# $Header: /var/cvsroot/gentoo-x86/dev-perl/XML-LibXML/XML-LibXML-1.63.ebuild,v 1.8 2007/11/10 15:27:47 drac Exp $
...
src_unpack() {
	unpack ${A}
	epatch "${FILESDIR}/XML-LibXML-1.63-test03.patch"
}
