...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/dcraw/dcraw-8.73.ebuild,v 1.9 2007/07/26 18:09:41 corsair Exp $
...
src_install() {
	...
	if use gimp; then
		...
		# install plugin
		exeinto $(${gimptool} --gimpplugindir)/plug-ins || die "gimptool failed"
		doexe rawphoto || die "Installation failed"
	fi
}
